...
tools: read_file, write, search_replace, list_dir, codebase_search, glob_file_search, web_search, create_diagram, update_memory, todo_write, mcp_octocode_githubSearchRepositories, mcp_octocode_githubViewRepoStructure, mcp_gitmvp_get_file_tree, mcp_gitmvp_search_repositories, mcp_octocode_packageSearch
---
